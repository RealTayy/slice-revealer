...
| sliceDuration   | Number (Float)   | 1                     | [CodePen](https://codepen.io/maiCoding/pen/gQxZpJ) | The transition duration for a single slice.                                                                                                                                                                                                                                            |
| totalDuration   | Number (Float)   | 1.6                   | [CodePen](https://codepen.io/maiCoding/pen/gQxZpJ) | The transition duration of the entire animation.                                                                                                                                                                                                                                       |
